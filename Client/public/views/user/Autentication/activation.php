...
session_start();
 if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if($_POST['activation'] == $_SESSION["otpCode"]){
...
<?php isset($_SESSION['user_id']) ? $user_id = $_SESSION['user_id'] : null;?>
